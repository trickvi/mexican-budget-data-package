...
!function ($) {
	...
	var dataLoaded = function(data) {
		...
		if (node.children) {
			...
			children.push(change_label(node.children[child]));
		    }
		    node.children = children;
		}
		return node;
	    }
	    var modified_data = change_label(data);
    ...
    // dailybread function
    $.fn.extend({
	mexicanbubbletree: function(options) {
    ...
    $('.mexican-bubbletree').mexicanbubbletree();
